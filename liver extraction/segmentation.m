function [mask1, temp, smoothsegmentedbinaryareanew,masktumor1,OutlineOverlay1, OutlineOverlay2,finalimage]=segmentation(colourimage,upperthresh,lowerthresh)
...
% set the lower and upper thresholds for segmentation in meanimage
 indexset = find(upperthresh>meanimage & meanimage>lowerthresh);
